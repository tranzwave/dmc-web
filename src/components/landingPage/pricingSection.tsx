            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-8 max-w-full mx-auto justify-center">
                    {packages.map((plan, i) => (
                        <Card
                            key={i}
                            className={`cursor-pointer p-6 w-[320px] flex flex-col justify-between rounded-2xl bg-white/20 backdrop-blur-[24px] border border-white/40 shadow-md hover:shadow-lg transition-shadow duration-300 ease-in-out ${plan.tabValue === "plus" ? "ring-2 ring-[#2bc8a6] relative" : ""}`}>
                            {plan.tabValue === "plus" && (
                            ...
                            <div>
                                ...
                                <div className="mb-4 flex items-baseline gap-2">
                                    <span className="text-4xl font-extrabold text-[#2bc8a6]">
                                        ${plan.price}
                                    </span>
