        ...
        <section className="bg-gray-50 py-16" ref={ref}>
            <div className="max-w-6xl mx-auto px-4">
                ...
                <motion.p
                    ...
                    initial="hidden"
                    animate={controls}>
                    Follow these four simple steps to start your journey with ease and confidence.
                    Our streamlined process ensures you’re up and running quickly, with expert guidance every step of the way.
                </motion.p>
