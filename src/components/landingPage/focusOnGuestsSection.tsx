        ...
        <section className={cn("w-full bg-white px-4 sm:px-6 lg:px-8", className)}>
            <div className="max-w-7xl mx-auto grid items-center gap-12 lg:grid-cols-2">
                ...
                <StaggerParent className="max-w-2xl">
                    ...
                    <motion.ul className="mt-8 space-y-6" variants={staggerList} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.25 }}>
                        <Feature
...
function StaggerParent({ children, className = "", delay = 0 }: { children: React.ReactNode; className?: string; delay?: number }) {
    return (
        <motion.div
            className={className}
            initial="hidden"
