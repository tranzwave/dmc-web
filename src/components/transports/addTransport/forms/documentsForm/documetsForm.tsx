...
export const DocumentsSchema = z.object({
  ...
  guideLicense: z.string(),
  vehicleEmissionTest: z
    .string()
    .min(1, "Vehicle emission test is required")
    .optional()
    .or(z.literal("")),
...
interface DocumentsFormProps {
  isDriver: boolean; // Explicitly define the type for isDriver
}

const DocumentsForm = ({ isDriver }: DocumentsFormProps) => {
  const { setDocumetsDetails, transportDetails, setActiveTab } =
    useAddTransport();
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Enter guid license" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
