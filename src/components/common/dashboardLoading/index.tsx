...
import LoadingImage from "../../../../public/assets/icons/loader icon.png"
...
const LoadingLayout = ()=>{
    return (
      ...
      <h1 className="text-xl font-semibold text-[#A8B4BE] mt-3 animate-pulse">
        One sec.. We are loading your Data!
      </h1>
    </div>
    )
}
...
const LoadingSpinner = ({ width, height }:{width:number, height:number}) => {
    return (
      <div role="status">
        <svg
          aria-hidden="true"
          className="text-gray-200 animate-spin dark:text-gray-600 fill-[#A8B4BE]"
          viewBox="0 0 100 101"
          fill="none"
