...
const ActivityVoucherPDF = ({ vouchers, cancellation, bookingName, organization, user, currency }: ActivityVoucherPDFProps) => {
  
  if(!vouchers || vouchers.length === 0 || !vouchers[0]) return null
    ...
    <div className="flex flex-col border border-b-0">
      ...
      <div className="w-full text-center" style={{ fontWeight: 'bold', fontSize: '20px' }}>
        ...
        <div className="mt-10 text-[13px]">
          <div>Representative: {user?.fullName ?? ""}</div>
